...
def test_compare(kwargs):
    ...
    common_geometry_object = Ogive(base_radius=5, length=15)
    # just writing a CAD step file for visulisation
    common_geometry_object.export_stp_file("ogive.stp")
    ...
    my_source.space = openmc.stats.Point((0, 0, 3.75))

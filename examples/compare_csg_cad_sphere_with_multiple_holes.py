...
common_geometry_object = SphereWithMultipleHoles(sphere_radius=10, cylinder_radius=2)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("sphere_with_multiple_holes.stp")
...
# Create a DT point source offset from center to avoid holes
my_source = openmc.IndependentSource()
my_source.space = openmc.stats.Point((4, 4, 4))

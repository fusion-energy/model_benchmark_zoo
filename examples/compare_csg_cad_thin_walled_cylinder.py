...
common_geometry_object = ThinWalledCylinder(height=20, outer_radius=5, wall_thickness=0.2)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("thin_walled_cylinder.stp")
...
# Create a DT point source at center (inside the hollow)

...
common_geometry_object = CylinderInBox(box_width=12, cylinder_radius=3, cylinder_height=10)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("cylinder_in_box.stp")

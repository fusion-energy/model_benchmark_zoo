...
common_geometry_object = ThinWalledSphere(outer_radius=5, inner_radius=4.5)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("thin_walled_sphere.stp")
...
# Create a DT point source in the wall midpoint
my_source = openmc.IndependentSource()
my_source.space = openmc.stats.Point((4.75, 0, 0))

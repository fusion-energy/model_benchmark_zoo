...
common_geometry_object = Cone(height=10, base_radius=5)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("cone.stp")
...
# Create a DT point source in the lower half of the cone
my_source = openmc.IndependentSource()
my_source.space = openmc.stats.Point((0, 0, -2.5))

...
common_geometry_object = Pipe(height=20, outer_radius=5, inner_radius=4)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("pipe.stp")
...
# Create a DT point source inside the pipe wall
my_source = openmc.IndependentSource()
my_source.space = openmc.stats.Point((4.5, 0, 0))

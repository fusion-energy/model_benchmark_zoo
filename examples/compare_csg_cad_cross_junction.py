...
common_geometry_object = CrossJunction(arm_length=10, arm_width=4, depth=4)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("cross_junction.stp")

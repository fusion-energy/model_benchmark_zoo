...
common_geometry_object = BoxWithSphericalCavity(width=10, sphere_radius=3)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("box_with_spherical_cavity.stp")
...
common_geometry_object.export_h5m_file_with_cad_to_dagmc(
    filename='box_with_spherical_cavity.h5m',
    material_tags=['1'],
    min_mesh_size=0.01,
    max_mesh_size=0.5
)
dag_model = common_geometry_object.dagmc_model(
    h5m_filename='box_with_spherical_cavity.h5m',
    materials=[mat1]
)

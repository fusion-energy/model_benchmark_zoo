...
common_geometry_object = CladdedPlate(width=20, length=20, core_thickness=4, clad_thickness=1)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("cladded_plate.stp")

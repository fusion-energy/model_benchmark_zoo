...
common_geometry_object = TJunction(main_length=20, main_width=5, branch_length=10, branch_width=5, height=5)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("t_junction.stp")

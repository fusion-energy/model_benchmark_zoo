...
common_geometry_object = OverlappingSpheres(radius=5, separation=6)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("overlapping_spheres.stp")
...
# Source at center of sphere 1
my_source = openmc.IndependentSource()
my_source.space = openmc.stats.Point((-3, 0, 0))

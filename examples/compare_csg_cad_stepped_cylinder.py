...
common_geometry_object = SteppedCylinder(height=20, large_radius=6, small_radius=3)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("stepped_cylinder.stp")
...
# Create a DT point source in the lower (larger) section

...
common_geometry_object = PipeElbow(bend_radius=10, outer_radius=3, inner_radius=2)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("pipe_elbow.stp")
...
# Source at midpoint of the elbow wall (45 degrees, at bend radius)
import math
my_source = openmc.IndependentSource()
my_source.space = openmc.stats.Point((10 * math.cos(math.radians(45)), 10 * math.sin(math.radians(45)), 0))

...
common_geometry_object = EccentricNestedCylinders(height=20, outer_radius=6, inner_radius=2, offset=2)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("eccentric_nested_cylinders.stp")
...
# Source at center of inner cylinder
my_source = openmc.IndependentSource()
my_source.space = openmc.stats.Point((2, 0, 0))

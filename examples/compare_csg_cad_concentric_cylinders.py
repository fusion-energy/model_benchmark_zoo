...
common_geometry_object = ConcentricCylinders(height=20, radii=[2, 4, 6])
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("concentric_cylinders.stp")
...
# Source at center of innermost cylinder

...
common_geometry_object = DivertorMonoblock(width=20, height=25, depth=12, pipe_outer_radius=6, pipe_inner_radius=5)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("divertor_monoblock.stp")
...
# Source inside the block above the pipe
my_source = openmc.IndependentSource()
my_source.space = openmc.stats.Point((0, 0, 10))

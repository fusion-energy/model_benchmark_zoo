...
common_geometry_object = CubicLattice(box_width=20, sphere_radius=3)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("cubic_lattice.stp")
...
# Source inside one of the spheres at (5, 5, 5)
...
common_geometry_object.export_h5m_file_with_cad_to_dagmc(
    ...
    material_tags=['1', '1', '1', '1', '1', '1', '1', '1', '2'],
    min_mesh_size=0.01,
    max_mesh_size=0.5
)

...
common_geometry_object = LShaped(length=10, width=10, leg_thickness=3, height=5)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("l_shaped.stp")
...
# Create a DT point source in the horizontal leg
my_source = openmc.IndependentSource()
my_source.space = openmc.stats.Point((0, -3.5, 0))

...
common_geometry_object = ToroidalSector(major_radius=10, minor_radius=2, angle=90)
# just writing a CAD step file for visulisation
common_geometry_object.export_stp_file("toroidal_sector.stp")
...
# Source at midpoint of the sector (45 degrees)
import math

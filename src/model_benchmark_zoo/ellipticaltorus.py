...
class Ellipticaltorus:
    ...
    def cadquery_assembly(self):
        ...
        ellipticaltorus = cq.Workplane("XZ", origin=(self.major_radius, 0, 0)).ellipse(self.minor_radius2, self.minor_radius1).revolve(360, (-self.major_radius,0,0), (-self.major_radius,1,0))
